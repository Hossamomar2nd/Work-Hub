...
export const getAllCommunities = async (req, res) => {
    ...
    return res.status(400).json({ msg: "No communities found!" });
};
...
export const joinCommunity = async (req, res) => {
    ...
    if (result.modifiedCount === 0) {
        return res.status(200).json({ msg: "You Have Already Joined The Community!" });
    }
...
export const updateCommunity = async (req, res) => {
    ...
    if (communityToUpdate) {
        ...
        const update = {
            $set: {
                ...
                communityCategory: req.body.communityCategory,
                communityPosts: req.body.communityPosts,
                clientMemberIds: req.body.clientMemberIds,
                freelancerMemberIds: req.body.freelancerMemberIds,
    ...
    return res.status(400).json({ msg: "There is no community with such id to update." });
};
...
export const deleteCommunity = async (req, res) => {
    ...
    if (communityToDelete) {
        ...
        return res.status(200).json({ msg: "Community has been deleted successfuly." });
    }
...
export const uploadCoverImage = async (req, res) => {
    ...
    return res.status(200).json({ msg: "Cover image uploaded successfuly", data });
};
